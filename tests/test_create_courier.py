...
class TestCreateCourier:
    ...
    def test_create_courier_success(self, base_url, create_and_delete_courier):
    ...
    def test_create_duplicate_courier(self, base_url, create_and_delete_courier):
        courier = create_and_delete_courier
    ...
    def test_create_courier_missing_required_field(self, base_url, create_and_delete_courier, missing_field):
        courier = create_and_delete_courier
        payload = {"login": courier["login"], "password": courier["password"], "firstName": courier["firstName"]}
    ...
    def test_create_courier_check_status_and_body(self, base_url, create_and_delete_courier):
        courier = create_and_delete_courier
        payload = {"login": courier["login"], "password": courier["password"], "firstName": courier["firstName"]}
        response = requests.post(f"{base_url}/courier", json=payload)
